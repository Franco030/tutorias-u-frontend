...
export function GoogleLoginButton() {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      {!isConfigured && (
        <div className="w-full mb-2 p-2.5 rounded-lg bg-burgundy-50 dark:bg-burgundy-950/40 border border-burgundy-200 dark:border-burgundy-800 text-burgundy-800 dark:text-burgundy-300 text-xs flex items-start gap-2">
