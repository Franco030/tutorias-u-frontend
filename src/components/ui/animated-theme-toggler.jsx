...
// Se usan porcentajes para evitar bugs de escalado en Chrome con clip-path
...
export const AnimatedThemeToggler = ({
  ...
  const toggleTheme = useCallback(() => {
    ...
    const applyTheme = () => {
      ...
      // Alternar síncronamente para que View Transitions capture el snapshot correcto
    ...
    // Prevenir parpadeo en Firefox mientras inicia la animación JS
  ...
  return (
    ...
    >
      {isDark ? (
        ...
        <Moon className="w-5 h-5 transition-transform duration-200 rotate-0 hover:-rotate-12 text-granite-700" />
      )}
